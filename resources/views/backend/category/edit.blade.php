    ...
    <div class="card-body">
      <form method="post" action="{{route('category.update',$category->id)}}">
        ...
        <div class="form-group">
          ...
          <input type="checkbox" name='is_parent' id='is_parent' value='1' {{(($category->is_parent)? 'checked' : '')}}> Yes                        
        </div>

        <div class="form-group {{(($category->is_parent)? 'd-none' : '')}}" id='parent_cat_div'>
