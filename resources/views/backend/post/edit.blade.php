      ...
      <form method="post" action="{{route('post.update',$post->id)}}" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                  ...
                  <input id="inputTitle" type="text" name="title" placeholder="Enter media title"  value="{{$post->title}}" class="form-control">
                  @error('title')
        ...
        <div class="form-group">
                ...
                <div class="existing-images-grid">
                    @foreach($post->images as $img)
                        <div class="existing-image-item" data-image-id="{{ $img->id }}">
                            <img src="{{ asset($img->image) }}" alt="Post image" class="img-thumbnail">
                            <div class="image-overlay">
                                ...
                                <button type="button" class="btn btn-sm btn-primary set-main-btn" 
                                    ...
                                    @if($img->image === $post->photo)
                                        <i class="fas fa-star"></i> Main
                                    @else
                                        <i class="fas fa-star-o"></i> Set
                                    @endif
                                </button>
                            </div>
                        </div>
            ...
            <div class="new-images-upload">
                <h6 class="mb-2">Add New Media Files:</h6>
                <div class="image-upload-container">
                    ...
                    <div class="image-preview-container mt-3" id="imagePreviewContainer" style="display: none;">
                        <h6 class="mb-2">New Media Files:</h6>
        ...
        <input type="hidden" name="existing_main_image" id="existingMainImage" value="{{ $post->photo }}">
        ...
        <div class="form-group">
          ...
          @if($post->photo)
              <img id="mainPhotoPreview" src="{{ asset($post->photo) }}" alt="Main photo preview" style="height: 5rem; margin-top: 10px; display: block;" onerror="this.onerror=null;this.src='/images/no-image.png';">
          @else
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('click', function(e) {
            if (e.target.closest('.set-main-btn')) {
                ...
                document.getElementById('thumbnail').value = imagePath;
                
                // Update visual feedback
                document.querySelectorAll('.set-main-btn').forEach(b => {
                    b.innerHTML = '<i class="fas fa-star-o"></i> Set';
                });
                btn.innerHTML = '<i class="fas fa-star"></i> Main';
            }
        });
