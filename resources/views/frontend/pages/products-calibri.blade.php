...
<div class="aluprof-heading">Nos Produits</div>
...
<div class="aluprof-category-outer">
    <div class="aluprof-category-grid">
        @forelse($categories as $cat)
            <a href="{{ route('product-grids', ['category' => $cat->slug]) }}" class="aluprof-category-block" tabindex="0" aria-label="Voir les produits de {{ $cat->title }}">
                ...
                @if(!empty($cat->description))
                    <div class="aluprof-category-desc">{{ \Illuminate\Support\Str::limit(strip_tags($cat->description), 60) }}</div>
                @endif
            </a>
        @empty
